...
const numberA = ref(1);\r
const numberB = ref(1);\r
...
<template>\r
  ...
  <div>第一个数：<input v-model="numberA" @input="twoNumberAddTestFun" name="numberA"/></div>\r
  <div>第二个数：<input v-model="numberB" @input="twoNumberAddTestFun" name="numberB"/></div>\r
