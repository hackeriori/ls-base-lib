...
<\/script>`,-1)])),default:v(()=>[b(y,{onClick:r},{default:v(()=>t[0]||(t[0]=[c("必要性验证")])),_:1}),b(y,{onClick:d},{default:v(()=>t[1]||(t[1]=[c("空参不参与验证")])),_:1}),b(y,{onClick:p},{default:v(()=>t[2]||(t[2]=[c("验证的顺序")])),_:1}),t[4]||(t[4]=n("div",null,"验证消息",-1)),n("div",{style:C({color:l.value.startsWith("执行成功")?"green":"red"})},S(l.value),5)]),_:1})]),_:1})])}}});export{L as default};
